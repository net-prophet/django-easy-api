# Generated by Django 3.0.2 on 2020-01-11 04:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(default=example.app.widgets.models.default_store_id, on_delete=django.db.models.deletion.CASCADE, to='widgets.Store')),
            ],
        ),
        migrations.CreateModel(
            name='PurchaseItem',
